...
[docmost/docmost](https://github.com/docmost/docmost) and recording what it does, not by translating its
source. See `../docmost-port/specs/SPEC-001-docmost.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for the
...
## The interface — AGPL-3.0, as docmost/docmost licensed it

- `gui/`

That code was written by the docmost/docmost project, Copyright the docmost/docmost authors, and is shipped
here **verbatim**, reused rather than rebuilt, per this harness's RENDERING.md R3. It
remains under the licence its authors chose, unmodified, in `LICENSE-docmost` and beside
